...
page = st.sidebar.radio("Go to", ["🔍 Main App", "📏 PCI Estimator", "🧮 Cost Estimator", "📈 Model Analysis", "🧾 Export Report"])
...
# Cost Estimator Page
    ...
    if st.session_state.last_prediction is None:
        ...
        st.write(f"🛠️ Detected: **{label}**, Severity: **{severity}**")
